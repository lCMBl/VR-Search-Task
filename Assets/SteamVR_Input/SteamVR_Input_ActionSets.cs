...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Experiment p_Experiment;
        ...
        public static SteamVR_Input_ActionSet_Experiment Experiment
        {
            get
            {
                return SteamVR_Actions.p_Experiment.GetCopy<SteamVR_Input_ActionSet_Experiment>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Experiment = ((SteamVR_Input_ActionSet_Experiment)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Experiment>("/actions/Experiment")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Experiment};
        }
    }
}
